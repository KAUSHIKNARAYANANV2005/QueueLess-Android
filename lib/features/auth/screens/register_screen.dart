...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void initState() {
    super.initState();
    _role = widget.initialRole ?? 'customer';
  }
                ...
                child: SafeArea(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Join thousands of users', style: AppTextStyles.body.copyWith(color: Colors.white70)),
                    ],
                  ),
                ),
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: ['customer', 'business'].map((r) {
                          ...
                          child: GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: isSelected ? AppShadows.e1 : null,
                              ),
                  ...
                  PremiumInput(key: const Key('reg_name_field'),    label: 'Full Name', hint: 'Your full name',           controller: _nameCtrl,    prefixIcon: Icons.person_outline,         textInputAction: TextInputAction.next),
                  const SizedBox(height: 14),
                  PremiumInput(key: const Key('reg_email_field'),   label: 'Email',     hint: 'your@email.com',           controller: _emailCtrl,   keyboardType: TextInputType.emailAddress, prefixIcon: Icons.email_outlined,         textInputAction: TextInputAction.next),
                  const SizedBox(height: 14),
                  PremiumInput(key: const Key('reg_phone_field'),   label: 'Phone',     hint: '+91 98765 43210',          controller: _phoneCtrl,   keyboardType: TextInputType.phone,        prefixIcon: Icons.phone_outlined,         textInputAction: TextInputAction.next),
                  const SizedBox(height: 14),
                  ...
                  const SizedBox(height: 14),
                  PremiumInput(
                    key: const Key('reg_confirm_field'),
                  ...
                  Center(
                    child: TextButton(
                      ...
                      child: Text.rich(TextSpan(text: 'Already have an account? ', style: AppTextStyles.body, children: [TextSpan(text: 'Sign In', style: AppTextStyles.body.copyWith(color: AppColors.primary, fontWeight: FontWeight.w600))])),
                    ),
                  ),
                ],
              ),
