        ...
        child: Column(
          children: [
            ...
            ClipPath(
              ...
              child: Container(
                height: 180,
                decoration: BoxDecoration(gradient: AppGradients.aurora), // distinctive look
                child: SafeArea(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('Business Register', style: AppTextStyles.h1.copyWith(color: Colors.white)),
                      Text('Manage your queue, staff, and bookings!', style: AppTextStyles.body.copyWith(color: Colors.white70)),
                    ],
                  ),
                ),
              ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  PremiumInput(
                    key: const Key('reg_biz_name_field'),
                  ...
                  PremiumInput(
                    key: const Key('reg_biz_email_field'),
                  ...
                  const SizedBox(height: 14),
                  PremiumInput(
                    key: const Key('reg_biz_phone_field'),
                  ...
                  ValueListenableBuilder(
                    ...
                    builder: (_, __, ___) {
                      return Column(
                        ...
                        children: [
                          PremiumInput(
                            key: const Key('reg_biz_password_field'),
                            label: 'Password',
                  ...
                  const SizedBox(height: 14),
                  PremiumInput(
                    key: const Key('reg_biz_confirm_field'),
                  ...
                  PremiumButton(
                    key: const Key('register_biz_submit_btn'),
                  ...
                  Center(
                    child: TextButton(
                      onPressed: () => context.go('/login?role=business'),
                      child: Text.rich(
                        TextSpan(
